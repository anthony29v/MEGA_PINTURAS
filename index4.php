					...
					<section class="tiles">
						<div class="contenido">
							<div class="fondoProducto">
								<a href="#">
									<center><img src="IMAGENES PROYECTO/inicio/p7.jpg" alt=""></center>
								</a>
							</div>
						</div>
						...
						<article class="style3">
							<span class="image">
								<img src="IMAGENES PROYECTO/productos/p11.jpeg" alt="" />
							</span>
							<br>
							<h2>Motoguadaña Manual</h2>
							<p>Motoguadaña Manual</p>
							<center>
								<h3>$ 200,00</h3>
							<input type="number" value="Cantidad">
							</center><br>
						...
						<article class="style1">
							<span class="image">
								<img src="IMAGENES PROYECTO/productos/p12.jpeg" alt="" />
							</span>
							<br>
							<h2>Bomba Manual 6 ltr</h2>
							<p>Bomba Manual 6 ltr</p>
							<center>
								<h3>$ 7,00</h3>
							<input type="number" value="Cantidad">
							</center><br>
						...
						<article class="style3">
							<span class="image">
								<img src="IMAGENES PROYECTO/productos/p16.jpeg" alt="" />
							</span>
							<br>
							<h2>Sikaboon</h2>
							<p>Sikaboon</p>
						...
						<article class="style4">
							<span class="image">
								<img src="IMAGENES PROYECTO/productos/p14.jpeg" alt="" />
							</span>
							<br>
							<h2>Bomba Manual 3 ltr</h2>
							<p>Bomba Manual 3 ltr</p>
							<center>
								<h3>$ 5,00</h3>
							<input type="number" value="Cantidad">
							</center><br>
						...
						<article class="style5">
							<span class="image">
								<img src="IMAGENES PROYECTO/productos/p50.jpeg" alt="" />
							</span>
							<br>
							<h2>Bomba Manual 2 ltr</h2>
							<p>Bomba Manual 2 ltr</p>
							<center>
								<h3>$ 4,00</h3>
							<input type="number" value="Cantidad">
							</center><br>
						...
						<article class="style6">
							<span class="image">
								<img src="IMAGENES PROYECTO/productos/p30.jpeg" alt="" />
							</span>
							<br>
							<h2>Zapato industrial</h2>
							<p>Zapato industrial</p>
							<center>
								<h3>$ 30,00</h3>
							<input type="number" value="Cantidad">
							</center><br>
